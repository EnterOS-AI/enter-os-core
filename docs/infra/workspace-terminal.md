...
> (private — EnterOS org members only).
...
Tracking: originally `enter-os-core#1528` (resolved 2026-04-22). Future
terminal work is tracked in `enter-os-core` issues (workspace-server scope)
