...
EnterOS's Lark channel adapter (shipped in #480) lets any workspace agent
...
- A EnterOS workspace already running (any runtime)
...
EnterOS surfaces `code != 0` as a hard Go error so your agent sees an
...
EnterOS canvas without code changes.

## Related

- PR #480: [feat(channels): Lark / Feishu channel adapter](https://github.com/EnterOS-AI/enter-os-core/pull/480)
