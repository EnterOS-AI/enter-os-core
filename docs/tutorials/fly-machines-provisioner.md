...
- PR #501: [feat(platform): Fly Machines provisioner](https://github.com/EnterOS-AI/enter-os-core/pull/501)
- PR #481: [feat(ci): deploy to Fly after image push](https://github.com/EnterOS-AI/enter-os-core/pull/481)
- [Fly Machines API docs](https://fly.io/docs/machines/api/)
- [Platform API reference](../api-reference.md)
- Issue [#525](https://github.com/EnterOS-AI/enter-os-core/issues/525)
