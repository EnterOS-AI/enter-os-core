...
Postgres and Redis must not expose host ports. They communicate exclusively over the internal Docker network (`enter-os-core-net`). Use `docker compose exec` for direct access during development.
