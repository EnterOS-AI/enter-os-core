...
LangGraph natively supports pausing an agent to ask for human approval. EnterOS extends this with **hierarchical escalation** — an agent can pause and escalate approval up the workspace hierarchy.
