...
//
// The acme-demo production data-loss bug (CEO Ryan PC's long-form
...
// canvas refresh drops the message — same shape as acme-demo. A
...
%s
This is the acme-demo data-loss regression class: live message
